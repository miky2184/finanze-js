(function () {
    ...
    angular.module('myApp', ['ngMaterial', 'ngMessages', 'ui.grid', 'ui.bootstrap', 'ui.grid.selection', 'ui.grid.cellNav', 'ui.grid.edit', 'ui.grid.exporter', 'ui.grid.treeView', 'nvd3', 'ui.grid.pinning', 'ui.grid.autoResize', 'ui.select']).config(['$mdThemingProvider', function ($mdThemingProvider) {
    ...
    }]).controller('MainController', ['$scope', '$http', 'uiGridConstants', '$log', '$q', '$interval', '$timeout', '$uibModal', '$strings', 'modalService', 'restService', 'utilService', 'spesaService', 'budgetService', 'reportMeseService', 'fantacalcioService', 'matchAnalysisService', 'amazonService', function ($scope, $http, uiGridConstants, $log, $q, $interval, $timeout, $uibModal, $strings, modalService, restService, utilService, spesaService, budgetService, reportMeseService, fantacalcioService, matchAnalysisService, amazonService) {
        $scope.dirty = false;
        $scope.season = {};
        $scope.season.value = {};
        $scope.fanta = {};
        ...
        *********************/
        ...
        $scope.loadMatchAnalysis = function () {
            return matchAnalysisService.loadMatchAnalysis($scope.season.value, $scope.giornata.value);
        };
